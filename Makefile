...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/10 18:47:43 by sdonya            #+#    #+#              #
#    Updated: 2019/11/26 16:38:22 by sdonya           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =   ft_atoi.c           ft_bzero.c          ft_isalnum.c        ft_isalpha.c        \
		...
		ft_lstiter.c        ft_lstmap.c		ft_amount_of_numbers.c	ft_max_dividend.c	\
		ft_num_all_sum.c	ft_sum_of_squares.c		ft_swap.c
